package com.example.firebasegroupapp10.Adapter
...
import com.example.firebasegroupapp10.databinding.ActivityMainBinding
import com.example.firebasegroupapp10.databinding.ViewholderBrandBinding
import com.example.firebasegroupapp10.databinding.ViewholderColorBinding
import com.example.firebasegroupapp10.databinding.ViewholderSizeBinding
...
class SizeAdapter(val items:MutableList<String>):
    ...
    override fun onBindViewHolder(holder: SizeAdapter.Viewholder, @SuppressLint("RecyclerView") position: Int) {
        ...
        if (selectedPosition==position){
            ...
            holder.binding.sizeLayout.setBackgroundColor(R.drawable.grey_bg)
